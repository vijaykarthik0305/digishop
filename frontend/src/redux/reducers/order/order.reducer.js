...
// New Order Cancellation Reducer
export const orderCancelReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    case OrderActionTypes.ORDER_CANCEL_REQUEST:
      return {
        loading: true,
      };
    case OrderActionTypes.ORDER_CANCEL_SUCCESS:
      return {
        loading: false,
        success: true,
      };
    case OrderActionTypes.ORDER_CANCEL_FAILURE:
      return {
        loading: false,
        error: action.payload,
      };
    case OrderActionTypes.ORDER_CANCEL_RESET:
      return {};
